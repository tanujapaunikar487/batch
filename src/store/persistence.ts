...
function seedState(): NotesState {
  ...
  return {
    ...
    notes: [
      ...
      { id: "u3", sectionId: INBOX_ID, text: "Ask Claude to **summarise the thread** and pull out the action items", priority: "medium", done: false, createdAt: now - 30 * H, handedOff: now - 2 * H },
      ...
      { id: "p1", sectionId: "prompts", text: "Explain the tradeoffs of server components vs. client components for a dashboard with heavy interactivity", priority: "high", done: false, createdAt: now - 10 * H, handedOff: now - 3 * H, outcome: { text: "Short answer: server components for the shell, client for the interactive islands. Details in the doc.", at: now - 1 * H, by: "agent" } },
